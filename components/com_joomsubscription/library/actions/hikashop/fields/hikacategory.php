...
class JFormFieldHikacategory extends \Joomla\CMS\Form\Field\ListField
{
	...
	public function getOptions()
	{
		...
		//array_unshift($items, Joomla\CMS\HTML\HTMLHelper::_('select.option', 0, \Joomla\CMS\Language\Text::_('EM_SELECT_CATEGORY')));
