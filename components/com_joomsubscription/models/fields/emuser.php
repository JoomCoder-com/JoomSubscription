 ...
 * @since       11.1
 */
class JFormFieldEmuser extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		$link = 'index.php?option=com_joomsubscription&amp;view=emusers&amp;layout=modal&amp;tmpl=component&amp;field='.$this->id.(isset($groups) ? ('&amp;groups='.base64_encode(json_encode($groups))) : '').(isset($excluded) ? ('&amp;excluded='.base64_encode(json_encode($excluded))) : '');
		...
		$script[] = '		}';
		$script[] = '		SqueezeBox.close(); //jModalClose();';
		$script[] = '	}';
