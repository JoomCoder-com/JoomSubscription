...
<div class="mainwrap">
		...
		<tr>
			<td>
				...
				<?php if($this->params->get('tax_id')): ?>
					<?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_TAX_ID');?>: <?php echo $this->params->get('tax_id')?><br />
				<?php endif; ?>
			...
			<td>
				<table class="table table-bordered table-condensed">
					...
					<tbody>
						...
						<tr>
							<td><?php echo \Joomla\CMS\Language\Text::_('OFF_BILL_INST')?></td>
	...
	<div class="row">
		...
		<table class=" table table-bordered float-end" style="width: 25%;">
			<tbody>
				<tr>
					<td class="align-right bold"><?php echo \Joomla\CMS\Language\Text::_('EDISCOUNT')?>:</td>
				...
				<tr>
					<td class="align-right bold"><?php echo \Joomla\CMS\Language\Text::_($this->tax->tax_name)?> <?php echo $this->tax->tax?>%:</td>
					<td class="align-right">
