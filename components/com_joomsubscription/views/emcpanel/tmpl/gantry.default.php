...
<!--<h3 class="cpbuttonstitle"><?php echo JText::_('EMCPQUIKICONS'); ?></h3>-->
<div class="cpbuttons g-grid">
            
            <div class="cpbut g-block size-16">
...
<!--<h3 class="cpbuttonstitle"><?php echo JText::_('EMCPQUIKICONSUSER'); ?></h3>-->
<div class="cpbuttons g-grid">
...
<!--<h3 class="cpbuttonstitle"><?php echo JText::_('EMCPQUIKICONSTOOLS'); ?></h3>-->
            <div class="cpbut g-block size-16 ">
...
<div class="cpsalesprogress g-grid">
...
<div class="cplastsubscr g-grid">
    <div class="g-block size-100">
        <h3 class=""><?php echo JText::_('ELASTSUBSCR'); ?></h3>
...
<?php if ($this->activate): ?>
    <div class="cpactivesubscr g-grid">
        <div class="g-block size-100">
            <h3 class="cpbuttonstitle"><?php echo JText::_('ENOTACTIVESUBSCR'); ?> <span class="badge badge-important"><?php echo
        count($this->activate); ?></span></h3>
            <div class="alert alert-danger alert-small">
                <small><?php echo JText::_('EADTIVATEDESCR'); ?></small>
            </div>
