...
<form action="<?php echo JRoute::_('index.php?option=com_joomsubscription&view=emfields');?>" method="post" name="adminForm" id="adminForm" class="uk-form">
	...
	<div class="page-header">
		...
		<h1>
			...
			<?php echo JText::_('COM_JOOMSUBSCRIPTION_FIELDS'); ?>
		</h1>
	</div>
<hr />
