...
class JoomsubscriptionViewEmGroup extends MViewBase
{
	...
	private function _prepareDocument()
	{
		...
		if($this->item->id)
		{
			$title = \Joomla\CMS\Language\Text::sprintf('EEDITGROUP', $this->item->name);
			$pathway->addItem(strip_tags($title));
		}
		else
		{
			$title = \Joomla\CMS\Language\Text::_('ENEWGROUP');
			$pathway->addItem(strip_tags($title));
		}
