...
<div class="container">
	<button class="btn btn-block btn-print" onclick="window.print();"><?php echo \Joomla\CMS\Language\Text::_('EM_PRINT'); ?></button>
	<div class="mainwrap">
		<table class="invtable">
			<tr>
				...
				<span class="company-name">
					...
					<?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_TAX_ID'); ?>:
					...
					<?php endif; ?>
					<?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_PHONE'); ?>: <?php echo $this->params->get('phone') ?><br/>
				</td>
				<td>
					<?php if($this->params->get('logo')): ?>
						<img src="<?php echo \Joomla\CMS\Uri\Uri::root(TRUE) . '/' . $this->params->get('logo') ?>" alt="<?php echo $this->params->get('name') ?>"/>
					<?php endif; ?>
				</td>
			</tr>
			<tr>
				<td>
					<table class="table table-bordered table-condensed">
						<thead>
						<tr class="gray">
							<th width="1%" nowrap="nowrap"><?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_BILLTO'); ?></th>
							<td>&nbsp;</td>
						</tr>
						</thead>
						<tbody>
						<tr>
							<td><?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_BILLTO') ?></td>
							<td><?php echo $this->invoice->fields->get('billto') ?></td>
						</tr>
						<tr>
							<td><?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_ADDRESS') ?></td>
							<td><?php echo $this->invoice->fields->get('address') ?></td>
						</tr>

						<?php if($this->invoice->fields->get('tax_id')): ?>
							<tr>
								<td><?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_TAX_ID') ?></td>
								<td>
						...
						<tr>
							<td><?php echo \Joomla\CMS\Language\Text::_('ECOUNTRY') ?></td>
							<td><?php echo $this->invoice->fields->get('country') ?></td>
						</tr>
						<?php if($this->invoice->fields->get('state', FALSE)): ?>
							<tr>
								<td><?php echo \Joomla\CMS\Language\Text::_('ESTATE') ?></td>
								<td><?php echo $this->invoice->fields->get('state') ?></td>
							</tr>
						<?php endif; ?>
						<tr>
							<td><?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_ZIP') ?></td>
							<td><?php echo $this->invoice->fields->get('zip') ?></td>
						</tr>
						<tr>
							<td><?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_PHONE') ?></td>
				...
				<td>
					<table class="table table-bordered table-condensed">
						<thead>
						<tr class="gray">
							<th width="1%" nowrap="nowrap"><?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_INFO') ?></th>
							<td>&nbsp;</td>
						</tr>
						</thead>
						<tbody>
						<tr>
							<td><?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_NUM') ?></td>
							<td><?php echo $this->subscr->invoice_num ?></td>
						</tr>
						<tr>
							<td><?php echo \Joomla\CMS\Language\Text::_('E_INVOICE_DATE') ?></td>
							<td><?php echo JoomsubscriptionHelper::getFormattedDate($this->subscr->ctime) ?></td>
						</tr>
						<tr>
							<td><?php echo \Joomla\CMS\Language\Text::_('E_PAYMENT_METHOD') ?></td>
							<td><?php echo \Joomla\CMS\Language\Text::_($this->subscr->gateway) ?></td>
						</tr>
						<tr>
							<td><?php echo \Joomla\CMS\Language\Text::_('E_PAYMENT_ID') ?></td>
		...
		<div class="row">
			<span class="order-item"><?php echo \Joomla\CMS\Language\Text::_('E_ORDER_ITEM') ?></span>
			<table class="table table-bordered table-items table-condensed">
				<thead>
				<tr class="gray">
					<th>#</th>
					<th><?php echo \Joomla\CMS\Language\Text::_('EDESCR') ?></th>
					<th><?php echo \Joomla\CMS\Language\Text::_('X_PRICE') ?></th>
				</tr>
				</thead>
				<tbody>
				<tr>
			...
			<table class=" table table-bordered float-end" style="width: 35%;">
				...
				<tr>
					<td class="align-right bold">
						<?php echo \Joomla\CMS\Language\Text::_('EDISCOUNT') ?>:<br/>
						<small>
							<?php echo $this->discount_type ? \Joomla\CMS\Language\Text::_('EM_DT_' . strtoupper($this->discount_type)) : NULL ?>
				...
				<tr class="success">
					<td class="align-right bold"><?php echo \Joomla\CMS\Language\Text::_('E_SUBTOTAL') ?>:</td>
					<td class="align-right bold"><?php echo JoomsubscriptionApi::getPrice($price, $this->plan->params, $this->subscr->params) ?></td>
				</tr>
				<?php $tax = 0;
				if(!empty($this->tax['percent'])): ?>
					<tr>
						<td class="align-right bold"><?php echo \Joomla\CMS\Language\Text::_($this->tax['name']) ?> <?php echo $this->tax['percent'] ?>%:</td>
						<td class="align-right">
				...
				<?php $price += $tax; ?>
				<tr>
					<td class="align-right bold"><big><?php echo \Joomla\CMS\Language\Text::_('EMR_INVOICETOTAL')?>:</big></td>
